...
class TestCliCommandsExist:
    ...
    @pytest.mark.parametrize("cmd", [
        ...
        "debug-select-backend", "debug-start", "debug-attach", "debug-detach", "debug-exit",
...
class TestCliRpcCommands:
    ...
    @pytest.mark.parametrize("cmd,extra_args,expected_rpc_cmd,expected_keys", [
        ...
        ("debug-select-backend", ["win32"], "debug_select_backend", {"backend", "remote"}),
        ("debug-start", [], "debug_start", {"wait_timeout", "suspend_at"}),
        ("debug-start", ["--backend", "win32"], "debug_start", {"backend", "remote", "wait_timeout", "suspend_at"}),
        ("debug-attach", ["1234"], "debug_attach", {"pid", "wait_timeout"}),
        ("debug-attach", ["1234", "--backend", "win32"], "debug_attach", {"pid", "backend", "remote", "wait_timeout"}),
        ("debug-detach", [], "debug_detach", set()),
        ("debug-exit", [], "debug_exit", set()),
        ("debug-continue", [], "debug_continue", {"wait_timeout"}),
        ("debug-suspend", [], "debug_suspend", {"wait_timeout"}),
        ("debug-step-into", [], "debug_step_into", {"wait_timeout"}),
        ("debug-step-over", [], "debug_step_over", {"wait_timeout"}),
        ("debug-run-to", ["0x1000"], "debug_run_to", {"address", "wait_timeout"}),
        ("debug-status", [], "debug_status", set()),
        ("debug-get-registers", [], "debug_get_registers", set()),
        ("debug-get-registers", ["--register", "RIP"], "debug_get_registers", {"registers"}),
